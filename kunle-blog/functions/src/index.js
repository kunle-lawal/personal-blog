...
var store = (0, _redux.createStore)(_rootReducer.default, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk.default.withExtraArgument({
  getFirebase: _reactReduxFirebase.getFirebase,
  getFirestore: _reduxFirestore.getFirestore
})), (0, _reduxFirestore.reduxFirestore)(_fbConfig.default), (0, _reactReduxFirebase.reactReduxFirebase)(_fbConfig.default, {
  useFirestoreForProfile: true,
  userProfile: 'users',
  attachAuthIsReady: true
})));
store.firebaseAuthIsReady.then(function () {
