...
function (_Component) {
  ...
  function PostContent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PostContent)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(PostContent, [{
    ...
    value: function render() {
      ...
      var content = post ? post.content : ""; // console.log(content)
